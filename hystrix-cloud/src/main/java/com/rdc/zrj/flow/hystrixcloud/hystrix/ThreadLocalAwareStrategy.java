...
public class ThreadLocalAwareStrategy extends HystrixConcurrencyStrategy {
    ...
    public <T> Callable<T> wrapCallable(Callable<T> callable) {
        return existingConcurrencyStrategy != null
                ...
                .wrapCallable(new DelegatingUserContextCallable<T>(callable, UserContextHolder.userContext.get()))
                : super.wrapCallable(new DelegatingUserContextCallable<T>(callable, UserContextHolder.userContext.get()));
    }
}